...
function Dashboard({ searchCoin, curr }) {
  return (
    <section className="max-w-7xl mx-auto lg:h-5/6 md:gap-4 gap-9 grid grid-cols-1 md-grid-cols-2 lg:grid-cols-3 lg:grid-rows-5 m-6">
      ...
      <div className=" relative col-span-2 lg:col-span-1 w-full row-span-2 bg-white shadow-md hover:shadow-lg rounded-2xl transition-all duration-200 flex justify-center items-center max-h-96">
        <Portfolio curr={curr} />
        <img
      ...
      <div className="col-span-2 w-full lg:col-span-1 row-span-2">
        <ExchangeValues />
      </div>
    </section>
  );
